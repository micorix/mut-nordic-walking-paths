    ...
    return (
        <div className="lg:grid grid-cols-5 h-full">
           <div className="col-span-1 px-10 py-5">
               ...
               <Link to="/about-area"
                     className="font-bold text-sm hover:underline mt-2 inline-block">Zobacz ciekawe miejsca na trasie</Link>

               <p className="my-10">
                   <strong>Drukowanie mapy</strong><br />
                   Aby wydrukować mapę, najedź na ikonkę drukarki w lewym górnym rogu mapy, a następnie wybierz orientację strony.
               </p>
               ...
               <div className="mt-10">
                   ...
                   <a href={`/assets/track_data/${track.slug}.gpx`} download="" className="mt-5 items-center flex text-center px-5 py-2 border-2 border-blue-300 rounded">
